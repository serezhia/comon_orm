...
<Cards>
  <Card title="Architecture" href="/docs/orm/core/architecture" description="Follow the flow from schema source to generated client and runtime adapters." />
  <Card title="Platforms and limitations" href="/docs/orm/core/platforms-and-limitations" description="See what is production-ready today and where the boundaries still are." />
  <Card title="Choosing a runtime" href="/docs/orm/core/choosing-a-runtime" description="Choose between PostgreSQL, SQLite, Flutter SQLite, and in-memory based on workload and deployment shape." />
</Cards>
