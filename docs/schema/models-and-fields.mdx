...
This page focuses on scalar fields, defaults, keys, maps, and indexes. Continue with [Relations](/docs/orm/schema/relations) for relation ownership and [Enums](/docs/orm/schema/enums) for enum blocks.
...
- [Relations](/docs/orm/schema/relations) for one-to-one, one-to-many, self-relations, and compound references
- [Enums](/docs/orm/schema/enums) for enum fields and migration implications
- [Native types](/docs/orm/schema/native-types) for provider-specific `@db.*` coverage
