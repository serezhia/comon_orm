...
This page is about query shaping. For create/update/delete examples, continue with [CRUD](/docs/orm/dart/crud). For nested reads and writes, continue with [Relations and includes](/docs/orm/dart/relations-and-includes).
...
- [CRUD](/docs/orm/dart/crud) for the main delegate methods
- [Relations and includes](/docs/orm/dart/relations-and-includes) for relation filters plus include trees
- [Aggregations](/docs/orm/dart/aggregations) for summaries and grouped queries
