...
- [Shared databases](/docs/orm/migrations/shared-databases) for the reviewed rollout path
- [Flutter local SQLite](/docs/orm/migrations/flutter-local-sqlite) for device-local app upgrades
- [Rollback and recovery](/docs/orm/migrations/rollback-and-recovery) for failure handling and forward-fix guidance
