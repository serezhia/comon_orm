...
See the full type mapping and attribute examples in `/docs/schema/models-and-fields`.
...
See `/docs/schema/datasource-and-generator` for provider-specific setup guidance.
...
See `/docs/schema/datasource-and-generator` for full setup combinations.
...
See `/docs/schema/models-and-fields` and `/docs/schema/relations` for full examples.
...
See `/docs/schema/native-types` for the supported subset with example schemas.
