...
- `/docs/dart/crud` for write and read operations
- `/docs/dart/filtering-and-sorting` for `WhereInput`, `orderBy`, and pagination
- `/docs/dart/relations-and-includes` for nested writes and read shaping
- `/docs/dart/aggregations` for `aggregate()` and `groupBy()`
- `/docs/dart/transactions` for multi-step writes
- `/docs/dart/testing` for in-memory and generated-runtime test patterns
