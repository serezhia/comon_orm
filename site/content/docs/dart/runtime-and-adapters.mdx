...
- `/docs/core/choosing-a-runtime` for adapter selection
- `/docs/dart/testing` for in-memory and test-friendly setup
- `/docs/migrations` for rollout and recovery guidance
